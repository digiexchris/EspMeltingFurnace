...
SemaphoreHandle_t xpt2046_mutex = NULL;
...
{
	ESP_RETURN_ON_FALSE(mutex, ESP_ERR_INVALID_ARG, TAG,
						"esp_lcd_touch_xpt2046_set_spi_mutex: mutex must not be NULL");
	xpt2046_mutex = mutex;
	return ESP_OK;
}
